...
const splideList = document.querySelector('.super .splide__list')
    ...
    <li class="splide__slide">
          <div class="card">
              ...
              <div class="card_body">
                  ...
                  <p> price: $${value.proPrice.toFixed(2)}</p>
                  <button onclick="addToCart(${index})">add cart <i class="fa-solid fa-cart-shopping"></i></button>
              </div>
          </div>
                </li>
    `;
